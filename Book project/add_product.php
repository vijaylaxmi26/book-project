...
if(isset($_GET['id']) && $_GET['id']!=''){
    ...
    $sql="select product.*,category.cat_type as cat_type from `product`,`category` where `product_id`='$id' and `id` =`pcategory_id`";
...
move_uploaded_file($_FILES['photo']['tmp_name'],$target);
    ...
    if($msg==''){
        if(isset($_GET['id']) && $_GET['id']!=''){
            ...
            $sql1="INSERT INTO `product`(`product_name`, `product_discription`,`product_price`, `product_quantity`, `product_photo`, `pcategory_id`) 
